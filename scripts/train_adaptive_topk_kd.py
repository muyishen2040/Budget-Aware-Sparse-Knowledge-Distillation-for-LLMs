...
from src.losses import compute_cached_adaptive_topk_kd_loss
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="output/adaptive_topk_kd")
    parser.add_argument(
    ...
    print(f"Starting Adaptive Top-K KD training on device: {device} | Detected GPU: {gpu_name}")
    student.train()
    ...
    for epoch in range(num_epochs):
        for batch in tqdm(train_loader):
            ...
            loss, ce_loss, kl_loss = compute_cached_adaptive_topk_kd_loss(
